    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            this.btn1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (list.get(i).cnt1 > list.get(i).cnt2) {
                        ...
                        btn2.setBackgroundColor(ContextCompat.getColor(context, R.color.purple));
            ...
            this.scrap.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    int i = getAdapterPosition();
                    if(list.get(i).writer.equals(SaveSharedPreferences.getUserEmail(context))){
                        Toast.makeText(context,"내가 쓴 글은 스크랩 할 수 없습니다.",Toast.LENGTH_SHORT).show();
                    }else{
                ...
                try {
                    ...
                    if (success) {
                        ...
                        if (list.get(i).cnt1 > list.get(i).cnt2) { //왼쪽은 보라, 오른쪽은 핑크..
                            //viewHolder.btn1.setBackground(ContextCompat.getDrawable(context, R.drawable.gradation));
                            viewHolder.btn1.setBackgroundColor(ContextCompat.getColor(context, R.color.purple));
                            viewHolder.btn1.setTextColor(Color.WHITE);
                            viewHolder.btn2.setBackgroundColor(Color.WHITE);
                            viewHolder.btn2.setTextColor(Color.BLACK);
                        } else {
                            //viewHolder.btn2.setBackground(ContextCompat.getDrawable(context, R.drawable.gradation));
                            viewHolder.btn2.setBackgroundColor(ContextCompat.getColor(context, R.color.purple));
                            viewHolder.btn2.setTextColor(Color.WHITE);
